...
New-AzureRmResourceGroup -Name ParcsResourceGroup -Location westeurope

# Create a subnet configuration
$subnetConfig = New-AzureRmVirtualNetworkSubnetConfig -Name mySubnet -AddressPrefix 192.168.1.0/24

# Create a virtual network
$vnet = New-AzureRmVirtualNetwork -ResourceGroupName ParcsResourceGroup -Location westeurope `
-Name MYvNET -AddressPrefix 192.168.0.0/16 -Subnet $subnetConfig

# Create a public IP address and specify a DNS name
$pip = New-AzureRmPublicIpAddress -ResourceGroupName ParcsResourceGroup -Location westeurope `
...
$nsg = New-AzureRmNetworkSecurityGroup -ResourceGroupName ParcsResourceGroup -Location westeurope `
...
$nic = New-AzureRmNetworkInterface -Name myNic -ResourceGroupName ParcsResourceGroup -Location westeurope `
...
New-AzureRmVM -ResourceGroupName ParcsResourceGroup -Location westeurope -VM $vmConfig
